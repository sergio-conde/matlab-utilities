function [out_files,search_path] = proj_organigram(cfg)
...
search_path = cfg.main_path;                                       % main project folder 
for ilevel = 1:length(cfg.level_name)
    search_path = cat(2,search_path,['\' cfg.folder_coding{ilevel}]); % concatenate all levels 
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% if there is a string code for the file names %%%%%%%%%%%%%%%%%%%%%%%%%
if ~isempty(cfg.file_str)
    search_path = cat(2,search_path,['\' cfg.file_str]); % add to search path
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
all_files = dir(search_path); % all files matching the configuration 
